...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			RAISERROR (
					'El valor de cuv2 a registrar ya existe para el tipo de estrategia y campana seleccionado.'
					,16
					,1
					)
		END
		...
		BEGIN
			...
			BEGIN
				RAISERROR (
						'El valor de cuv2 a registrar ya existe para el tipo de estrategia y rango de campana seleccionado.'
						,16
						,1
						)
			END
		...
		BEGIN
			...
			BEGIN
				RAISERROR (
						'El orden ingresado para la estrategia ya esta siendo utilizado.'
						,16
						,1
						)
			END
