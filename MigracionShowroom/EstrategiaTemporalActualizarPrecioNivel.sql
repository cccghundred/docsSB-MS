...
BEGIN
	...
	FROM (SELECT CODIGOOFERTA,NumeroGrupo, PrecioUnitario, IndicadorPreUni,  FactorRepeticion, CodigoFactorCuadre 
	...
	FROM #EstrategiaTemporal ET
	WHERE ET.Ganancia >= 0
	/**** 2. Calculo de Ganancia - Fin ****/


	/**** 3. Calculo de Niveles - Ini ****/
	UPDATE PN
